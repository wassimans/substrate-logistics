...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	/// Storage: Logistics Something (r:0 w:1)
	/// Proof: Logistics Something (max_values: Some(1), max_size: Some(4), added: 499, mode: MaxEncodedLen)
	fn do_something() -> Weight {
	...
	/// Storage: Logistics Something (r:1 w:1)
	/// Proof: Logistics Something (max_values: Some(1), max_size: Some(4), added: 499, mode: MaxEncodedLen)
	fn cause_error() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `32`
